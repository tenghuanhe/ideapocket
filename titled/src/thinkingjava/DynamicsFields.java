 ...
 */
class DynamicFieldException extends ExtraException {

}

public class DynamicsFields {
    private Object[][] fields;

    public DynamicsFields(int initialSize) {
    ...
    public static void main(String[] args) {
        DynamicsFields df = new DynamicsFields(3);
